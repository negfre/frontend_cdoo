                        ...
                        <ul className="navbar-nav ml-auto">
                          ...
                          <li className="nav-item dropdown no-arrow">
                            <Link className="nav-link dropdown-toggle" to="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <span className="mr-2 d-none d-lg-inline text-gray-600 small">{auth.nombre}</span>
                            ...
                            <div className="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                              ...
                              {/* <a className="dropdown-item" to="{cerrarSesionAuth()}" data-toggle="modal" data-target="#logoutModal">
                                <i className="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400" />
                                Cerrar Sesion
                              </a> */}
                              <Link  to='/' className="dropdown-item" onClick={cerrarSesionAuth} data-dismiss="modal" data-target="#logoutModal">
                                <i className="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400" />
                                Cerrar Sesión
                              </Link>
