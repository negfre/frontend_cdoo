...
export const Content = () => {
  return (
    ...
    //             <h1 className="h3 mb-0 text-gray-800">Dashboard333</h1>
    //             <a href="/login" className="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i className="fas fa-download fa-sm text-white-50" /> Generate Report</a>
    //           </div>
    //           {/* Content Row */}
    //           <div className="row">
